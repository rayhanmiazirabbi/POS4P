...
from sqlalchemy import Date, DateTime, ForeignKey, Index, JSON, Numeric, String, UniqueConstraint
...
class DailyStoreMetric(StoreScopedMixin, UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    sales_total: Mapped[Decimal] = mapped_column(Numeric(18, 4), default=0, nullable=False)
    refund_total: Mapped[Decimal] = mapped_column(Numeric(18, 4), default=0, nullable=False)
    cost_total: Mapped[Decimal] = mapped_column(Numeric(18, 4), default=0, nullable=False)
